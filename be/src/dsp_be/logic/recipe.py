...
class Recipe:
    ...
    def production(
        self, count: int, machine: Machine, planet: Planet, config: Config
    ) -> Stack:
        pass
...
class PumpRecipe(Recipe):
    ...
    def production(
        ...
        stack = Stack()
        stack.add(
            self.product, 5.0 / 6.0 * count * (1 + 0.1 * config.veins_utilization)
        )
        return stack
...
class CollectorRecipe(Recipe):
    ...
    def production(
        ...
        fire_ice = (
            8
            * count
            * planet.resources.get("fire_ice", 0.0)
            * (1 + 0.1 * config.veins_utilization)
        )
        hydrogen = (
            8
            * count
            * planet.resources.get("hydrogen", 0.0)
            * (1 + 0.1 * config.veins_utilization)
        )
        deuterium = (
            8
            * count
            * planet.resources.get("deuterium", 0.0)
            * (1 + 0.1 * config.veins_utilization)
        )
        power = 30 * count
...
factory_recipes_txt: List[Dict[str, Any]] = [
    ...
    },
    {
        "name": "magnetic_coil",
        "machine": "assembler",
        "products": {"magnetic_coil": 2},
        "raws": {"magnet": 2, "copper_ingot": 1},
        "time": 1.0,
    },
    {
        "name": "prism",
    ...
    },
    {
        "name": "plasma_exciter",
        "machine": "assembler",
        "products": {"plasma_exciter": 1},
        "raws": {"magnetic_coil": 4, "prism": 2},
        "time": 2.0,
    },
    {
        "name": "titanium_crystal",
        "machine": "assembler",
        "products": {"titanium_crystal": 1},
        "raws": {"organic_crystal": 1, "titanium_ingot": 3},
        "time": 4.0,
    },
    {
        "name": "casimir_crystal",
        "machine": "assembler",
        "products": {"casimir_crystal": 1},
        "raws": {"titanium_crystal": 1, "graphene": 2, "hydrogen": 12},
        "time": 4.0,
    },
    {
        ...
        "machine": "assembler",
        "products": {"casimir_crystal": 1},
        "raws": {"optical_grating_crystal": 4, "graphene": 2, "hydrogen": 12},
        "time": 4.0,
    },
    {
        "name": "titanium_glass",
        "machine": "assembler",
        "products": {"titanium_glass": 2},
        "raws": {"glass": 2, "titanium_ingot": 2, "water": 2},
        "time": 5.0,
    },
    {
        "name": "patricle_broadband",
        "machine": "assembler",
        "products": {"patricle_broadband": 1},
        "raws": {"carbon_nanotube": 2, "crystal_silicon": 2, "plastic": 1},
        "time": 8.0,
    },
    {
        "name": "plane_filter",
        "machine": "assembler",
        "products": {"plane_filter": 1},
        "raws": {"casimir_crystal": 1, "titanium_glass": 2},
        "time": 12.0,
    },
    {
        "name": "deuteron_fuel_rod",
        "machine": "assembler",
        "products": {"deuteron_fuel_rod": 2},
        "raws": {"titanium_alloy": 1, "deuterium": 20, "super_magnetic_ring": 1},
        "time": 12.0,
    },
    {
        "name": "annihilation_constraint_sphere",
        "machine": "assembler",
        "products": {"annihilation_constraint_sphere": 1},
        "raws": {"patricle_container": 1, "processor": 1},
        "time": 20.0,
    },
    {
        "name": "circuit_board",
        "machine": "assembler",
        "products": {"circuit_board": 2},
        "raws": {"iron_ingot": 2, "copper_ingot": 1},
        "time": 1.0,
    },
    {
        "name": "processor",
        "machine": "assembler",
        "products": {"processor": 1},
        "raws": {"circuit_board": 2, "microcrystalline_component": 2},
        "time": 3.0,
    },
    {
        "name": "quantum_chip",
        "machine": "assembler",
        "products": {"quantum_chip": 1},
        "raws": {"processor": 2, "plane_filter": 2},
        "time": 6.0,
    },
    {
        "name": "microcrystalline_component",
        "machine": "assembler",
        "products": {"microcrystalline_component": 1},
        "raws": {"high_purity_silicon": 2, "copper_ingot": 1},
        "time": 2.0,
    },
    {
        "name": "crystal_silicon_plus",
        "machine": "assembler",
        "products": {"crystal_silicon": 2},
        "raws": {
            "fractal_silicon": 1,
        },
        "time": 1.5,
    },
    {
        ...
        "machine": "assembler",
        "products": {"photon_combiner": 1},
        "raws": {"prism": 2, "circuit_board": 1},
        "time": 3.0,
    },
    {
        ...
        "machine": "assembler",
        "products": {"photon_combiner": 1},
        "raws": {"optical_grating_crystal": 1, "circuit_board": 1},
        "time": 3.0,
    },
    {
        "name": "solar_sail",
        "machine": "assembler",
        "products": {"solar_sail": 2},
        "raws": {"graphene": 1, "photon_combiner": 1},
        "time": 4.0,
    },
    {
        "name": "frame_material",
        "machine": "assembler",
        "products": {"frame_material": 1},
        "raws": {"carbon_nanotube": 4, "titanium_alloy": 1, "high_purity_silicon": 1},
        "time": 6.0,
    },
    {
        "name": "dyson_sphere_component",
        "machine": "assembler",
        "products": {"dyson_sphere_component": 1},
        "raws": {"frame_material": 3, "solar_sail": 3, "processor": 3},
        "time": 8.0,
    },
    {
        "name": "small_carrier_rocket",
        "machine": "assembler",
        "products": {"small_carrier_rocket": 1},
        "raws": {
    ...
    },
    {
        "name": "electric_motor",
        "machine": "assembler",
        "products": {"electric_motor": 1},
        "raws": {"iron_ingot": 2, "gear": 1, "magnetic_coil": 1},
        "time": 2.0,
    },
    {
        "name": "electromagnetic_turbine",
        "machine": "assembler",
        "products": {"electromagnetic_turbine": 1},
        "raws": {"electric_motor": 2, "magnetic_coil": 2},
        "time": 2.0,
    },
    {
        "name": "particle_container",
        "machine": "assembler",
        "products": {"particle_container": 1},
        "raws": {"electromagnetic_turbine": 2, "copper_ingot": 2, "graphene": 2},
        "time": 4.0,
    },
    {
        ...
        "machine": "assembler",
        "products": {"particle_container": 1},
        "raws": {"unipolar_magnet": 10, "copper_ingot": 2},
        "time": 4.0,
    },
    {
        "name": "graviton_lens",
        "machine": "assembler",
        "products": {"graviton_lens": 1},
        "raws": {"diamond": 4, "strange_matter": 1},
        "time": 6.0,
    },
    {
        "name": "super_magnetic_ring",
        "machine": "assembler",
        "products": {"super_magnetic_ring": 1},
        "raws": {"electromagnetic_turbine": 2, "magnet": 3, "energetic_graphite": 1},
        "time": 3.0,
    },
    {
        "name": "iron_ingot",
        "machine": "smelter",
        "products": {"iron_ingot": 1},
        "raws": {"iron_ore": 1},
        "time": 1.0,
    },
    {
    ...
    },
    {
        ...
        "machine": "smelter",
        "products": {"crystal_silicon": 1},
        "raws": {"high_purity_silicon": 1},
        "time": 2.0,
    },
    {
        "name": "glass",
    ...
    },
    {
        ...
        "machine": "smelter",
        "products": {"high_purity_silicon": 1},
        "raws": {"silicon_ore": 2},
        "time": 2.0,
    },
    {
    ...
    },
    {
        "name": "titanium_alloy",
        "machine": "smelter",
        "products": {"titanium_alloy": 4},
        "raws": {"titanium": 4, "steel": 4, "sulfric_acid": 8},
        "time": 12.0,
    },
    {
        "name": "refining",
        "machine": "oil_refinery",
        "products": {"hydrogen": 1, "refined_oil": 2},
        "raws": {
            "crude_oil": 2,
        },
        "time": 4.0,
    },
    {
        "name": "x_ray_cracking",
        "machine": "oil_refinery",
        "products": {"hydrogen": 3, "energetic_graphite": 2},
        "raws": {
            "refined_oil": 1,
            "hydrogen": 2,
        },
    ...
    },
    {
        ...
        "raws": {"patricle_container": 2, "iron_ingot": 2, "deuterium": 10},
        "time": 8.0,
    },
    {
        "name": "plastic",
...
def load_recipes() -> RecipeBook:
    ...
    for recipe_txt in factory_recipes_txt:
        recipe = FactoryRecipe(
            name=recipe_txt["name"],
            machine=recipe_txt["machine"],
            products=copy.deepcopy(recipe_txt["products"]),
            raws=copy.deepcopy(recipe_txt["raws"]),
            time=recipe_txt["time"],
        )
        rb.add(recipe)
...
if __name__ == "__main__":
    ...
    planet = Planet(
        name="Jupiter",
        resources={"fire_ice": 0.04, "hydrogen": 0.85, "deuterium": 0.0},
        exports=[],
        imports=[],
        star=None,
    )
