...
@pytest.fixture
def jupiter():
    return Planet(name="Earth", resources={"fire_ice": 0.04, "hydrogen": 0.85}, exports=[], imports=[], star=None)
...
def test_orbital_collector(jupiter, orbital_collector):
    ...
    assert jupiter.production() == Stack(products={"deuterium": 0.0, "hydrogen":pytest.approx(196.4, 0.01), "fire_ice":pytest.approx(9.24, 0.01)})
