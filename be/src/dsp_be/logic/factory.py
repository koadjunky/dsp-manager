...
class Factory:
    ...
    def production(self) -> Stack:
        return self.recipe.production(self.count, self.machine, self.planet, self.config)
...
if __name__ == '__main__':
    ...
    factory1 = Factory(name="Circuit Board #1", machine_name='assembler1', recipe_name='circuit_board', count=6, planet=earth, config=config)
    factory2 = Factory(name="Iron Ingot #1", machine_name='arc_smelter', recipe_name='iron_ingot', count=9, planet=earth, config=config)
